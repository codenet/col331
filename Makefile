...
TOOLPREFIX := $(shell if i386-jos-elf-objdump -i 2>&1 | grep '^elf32-i386$$' >/dev/null 2>&1; \
	...
	echo "*** Error: Couldn't find an i386/i686-*-elf version of GCC/binutils." 1>&2; \
	echo "*** On Linux: install i386-elf-gcc or i386-jos-elf-gcc." 1>&2; \
	echo "*** On Mac: brew install i686-elf-gcc  (or i386-elf-gcc)." 1>&2; \
	echo "*** If your toolchain uses a different prefix, set TOOLPREFIX" 1>&2; \
