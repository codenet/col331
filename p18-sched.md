...
The previous part started two processes but when we pressed "Ctrl+P", we note that
...
When we call `swtch`, from GCC calling convention many *caller-save registers*
